...
fs.mkdir('hdfs://nc-de-vm-v3:8020/tmp/staging/final_project', create_parents=True)
local_path = '/tmp/staging/final_project/' + datestr + '.json'
with open(local_path, 'rb') as f:
    fs.upload('hdfs://nc-de-vm-v3:8020/tmp/staging/final_project/' + datestr + '.json', f)
...
df = spark.read.json("hdfs://nc-de-vm-v3:8020/tmp/staging/final_project/" + datestr + ".json")
